...
def toy_example(
    ...
    for i in range(0, num_timesteps):
        randint_1 = np.random.randint(10,np.round(lat_len/3))
        randint_2 = np.random.randint(10,np.round(lon_len/3))
        temp_array = np.random.normal(mu, sigma, size=(randint_1, randint_2))
        
        pad_1 = np.random.randint(2,np.round(lat_len/3))
        pad_2 = np.random.randint(2,np.round(lat_len/3))
        pad_3 = np.random.randint(2,np.round(lat_len/3))
        pad_4 = np.random.randint(2,np.round(lat_len/3))
...
def toy_example_into_full_time(
    num_timeres: int, 
    toy_temp_array: np.ndarray) -> np.ndarray:
...
def const_toy_example(
    toy_temp_array: np.ndarray, 
    const_tval: float) -> np.ndarray:
